...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/assets/css-js/usuario/unidade-ensino/cadastrar.css'/>" />
</head>
...
<body>
    ...
    <script src="<c:url value='/assets/css-js/usuario/unidade-ensino/cadastrar.js'/>"></script>
